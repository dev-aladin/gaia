...
function testServer() {
  ...
  test('get/set driver settings', (t) => {
    ...
    const azDriverSettings = {
      driver: 'azure',
      readURL: 'https://gaia.aladinnetwork.org/',
      pageSize: 100,
    ...
    const gcDriverSettings = {
      driver: 'google-cloud',
      readURL: 'https://aladinnetwork-gaia.google.com/hub',
      pageSize: 100,
      cacheControl: 'Max-Age 30',
      gcCredentials
    }
    ...
    const awsDriverSettings = {
      driver: 'aws',
      readURL: 'https://aladinnetwork-gaia.s3.amazonaws.com',
      pageSize: 100,
      cacheControl: 'Max-Age 30',
      awsCredentials
    }
