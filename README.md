...
If you would like to deploy your own hub, there are instructions available [here](https://drive.google.com/file/d/1--V9ers1q7WqDz9Zq9ThJN1TMj3tXLJs/view)
...
lookup. Instead, the aladin [authentication flow](https://github.com/dev-aladin/aladinjs/blob/master/src/auth/README.md#authentication-response-payload-schema) provides Alice's chosen application root
